...
class Signin extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://vast-temple-97785.herokuapp.com/signin',{
            method: 'post',
                    ...
                    <main className="pa4 black-80">
                        <div className="measure">
                            ...
                            <input
                                ...
                                className="white bg-black b ph3 pv2 input-reset ba b--white grow pointer f6 dib" 
                                type="submit" 
                                value="Sign in"/>
                            </div>
                            <div className="lh-copy mt3">
                                <p onClick={() => onRouteChange('register')} className="white pointer f6 link dim black db">Register</p>
                            </div>
                        </div>
                    </main>
                </div>
